...
You can then execute your native executable with: `./target/blaze-1.0-SNAPSHOT-runner`
...
- REST resources for Hibernate ORM with
  Panache ([guide](https://quarkus.io/guides/rest-data-panache)): Generate JAX-RS resources for your
  Hibernate Panache entities and repositories
